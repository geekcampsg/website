export default {
  year: '2019',
  videos: 'https://engineers.sg/conference/geekcampsg-2019',
  venue:
      ...
      talks: [
        {
          ...
          speakers: [
            {
              ...
              imgUrl: 'speakers/past/sausheong.jpg',
            },
          ],
          ...
          video: 'https://youtu.be/EYxPLc5cx8Y',
        },
        {
          title: 'Building Web-Based Audio Player for Obscure Audio Format',
          speakers: [{
            name: 'Kenrick', position: 'Front-End Engineer, Shopee',
            imgUrl: 'speakers/past/kenrick.jpeg',
          }],
          summary:
          ...
          video: 'https://youtu.be/JQFdrAwwFSY',
        },
        {
          title:
            'Implementing Open Source-Based Motion Controlled Robotic Arms with Python and C',
          speakers: [{
            name: 'Renaldi Gondosubroto', position: 'Founder and CEO, GReS Studio',
            imgUrl: 'speakers/past/Renaldi-Gondosubroto.png',
          }],
          summary:
          ...
          video: 'https://youtu.be/KjpJUAYZfzU',
        },
        {
          title:
          ...
          speakers: [{
            ...
            imgUrl: 'speakers/past/muhammad_hazwan.jpg',
          }],
          summary:
          ...
          video: 'https://youtu.be/RVgezwzclJI',
        },
        {
          title: 'Creating Art from Music',
          speakers: [{
            name: 'Subhransu Behera', position: 'Principal Software Engineer, SP Digital',
            imgUrl: 'speakers/past/subhransu_behera.jpg',
          }],
          summary:
          ...
          video: 'https://youtu.be/m-FKYHCOFdo',
        },
        {
          title: 'Love At First Byte: a romantic journey into the future of us',
          speakers: [{
            name: 'Sudharshan',
            position: 'Hacker, Maker, Coder, Tech-Enthusiast',
            imgUrl: 'speakers/past/Sudharshan.jpeg',
          }],
          summary:
          ...
          video: 'https://youtu.be/5mEMh69JR7I',
        },
        {
          title: 'Implementing Trigonometry in SCSS, and lessons learnt',
          speakers: [{ name: 'Liu Weiyuan', position: 'Full Stack Engineer, Rakuten Viki', imgUrl: 'speakers/past/weiyuan.jpg', }],
          summary:
          ...
          video: 'https://youtu.be/DE_q52uAj1w',
        },
        {
          title:
          ...
          speakers: [{
            ...
            imgUrl: 'speakers/past/dipesh.jpg',
          }],
          summary:
          ...
          video: 'https://youtu.be/CysBXTJe3QU',
        },
        {
          title: 'The Singapore Tech Community - A 10 year retrospective',
          speakers: [{ name: 'Michael Cheng' }],
          summary:
          ...
          video: 'https://youtu.be/DmheY4_0FA0',
        },
      ],
      workshop: [
        {
          title: 'Workshop 1: Getting Started with Smart Contracts',
          speakers: [{
            name: 'Yos Riady', position: 'Software Engineer, TenX',
            imgUrl: 'speakers/past/yosss.jpg',
          }],
          summary:
          ...
          video: 'https://youtu.be/QiJ_zN82ry4',
        },
        {
          title: 'Workshop 2: Virtual Network Testbed Using GNS3',
          speakers: [{ name: 'Hazwan Hassan' }],
          summary:
            'Ever wanted to build complex virtual networks to test and practice networking concepts or build a test production environment for practicing software development but find building such networks difficult? In this workshop, learn about GNS3 and how to build and manage virtual networks visually.',
          video: 'https://youtu.be/ysLpOsY-WQI',
        },
      ],
      'community-village': [
        {
          title: 'Challenge by OSI Layer 8',
          summary: 'Opening connection to ctf.makerforce.io',
        },
        {
          title: 'GeekcampSG x Women Who Code Singapore',
          summary:
            'Machines Learning and Edge Computing Workshop. This workshop will help you get familiarised with the powerful use of deep learning models on the small devices. We will tackle the problem of recognising hand gestures by using the RealSense depth sensing camera and then run our model on the edge using Intel’s Neural Compute Stick.',
        },
      ],
    },
  ],
  'speakers-bio': [
    {
      speaker: 'Micheal Cheng',
      position: 'Lead Engineer, GovTech',
      imgUrl: 'speakers/past/michael_cheng.jpeg',
    },
  ],
};
